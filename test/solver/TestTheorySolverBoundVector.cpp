...
class TestTheorySolverBoundVector : public ::testing::Test {
 protected:
  ...
  TestTheorySolverBoundVector() : bounds_{inf_}, empty_bounds_{inf_} {
...
TEST_F(TestTheorySolverBoundVector, ConstructorSingle) {
...
TEST_F(TestTheorySolverBoundVector, ConstructorDouble) {
...
TEST_F(TestTheorySolverBoundVector, OnlyLowerBoundsActiveBounds) {
  empty_bounds_.AddBound(1, LpColBound::L, idx());
  empty_bounds_.AddBound(1, LpColBound::SL, idx());
  empty_bounds_.AddBound(2, LpColBound::L, idx());
  empty_bounds_.AddBound(3, LpColBound::L, idx());
  empty_bounds_.AddBound(3, LpColBound::SL, idx());
...
TEST_F(TestTheorySolverBoundVector, OnlyUpperBoundsActiveBounds) {
  empty_bounds_.AddBound(1, LpColBound::U, idx());
  empty_bounds_.AddBound(1, LpColBound::SU, idx());
  empty_bounds_.AddBound(2, LpColBound::U, idx());
  empty_bounds_.AddBound(3, LpColBound::U, idx());
  empty_bounds_.AddBound(3, LpColBound::SU, idx());
  auto it = empty_bounds_.active_bounds();
  EXPECT_EQ(it.size(), 2u);
  EXPECT_EQ(it.bounds_size(), 2u);
  EXPECT_TRUE(it.nq_bounds_empty());
...
TEST_F(TestTheorySolverBoundVector, NqBoundsActiveBounds) {
  empty_bounds_.AddBound(0, LpColBound::L, idx());
  empty_bounds_.AddBound(0, LpColBound::SL, idx());
  empty_bounds_.AddBound(0, LpColBound::D, idx());
  empty_bounds_.AddBound(1, LpColBound::L, idx());
  empty_bounds_.AddBound(1, LpColBound::SL, idx());
  empty_bounds_.AddBound(1, LpColBound::D, idx());
  empty_bounds_.AddBound(2, LpColBound::D, idx());
  empty_bounds_.AddBound(3, LpColBound::D, idx());
  empty_bounds_.AddBound(3, LpColBound::U, idx());
  empty_bounds_.AddBound(3, LpColBound::SU, idx());
  empty_bounds_.AddBound(4, LpColBound::D, idx());
  empty_bounds_.AddBound(4, LpColBound::U, idx());
  empty_bounds_.AddBound(4, LpColBound::SU, idx());
  auto it = empty_bounds_.active_bounds();
...
TEST_F(TestTheorySolverBoundVector, PriorityEqBoundsActiveBoundsOverLower) {
  ...
  empty_bounds_.AddBound(3, LpColBound::L, idx());
  empty_bounds_.AddBound(3, LpColBound::L, idx());
  empty_bounds_.AddBound(3, LpColBound::B, eq_idx);
  empty_bounds_.AddBound(3, LpColBound::L, idx());
  empty_bounds_.AddBound(3, LpColBound::L, idx());
  auto it = empty_bounds_.active_bounds();
  ...
  EXPECT_TRUE(it.nq_bounds_empty());
  EXPECT_EQ(it.bounds_size(), 2u);
  EXPECT_EQ(*it.bounds().first, std::make_tuple(3, LpColBound::L, eq_idx));
  EXPECT_EQ(*(it.bounds().first + 1), std::make_tuple(3, LpColBound::U, eq_idx));
}
...
TEST_F(TestTheorySolverBoundVector, EqBoundsActiveBounds) {
  ...
  empty_bounds_.AddBound(3, LpColBound::U, idx());
  empty_bounds_.AddBound(3, LpColBound::U, idx());
  empty_bounds_.AddBound(3, LpColBound::B, idx());
  empty_bounds_.AddBound(3, LpColBound::L, idx());
  empty_bounds_.AddBound(3, LpColBound::U, idx());
  auto it = empty_bounds_.active_bounds();
  EXPECT_EQ(it.size(), 7u);
...
TEST_F(TestTheorySolverBoundVector, ClearSingle) {
...
TEST_F(TestTheorySolverBoundVector, ClearDouble) {
...
TEST_F(TestTheorySolverBoundVector, IsActiveEqualityLUBounds) {
  TheorySolverBoundVector bounds{inf_};
  bounds.AddBound(1, LpColBound::L, idx());
  bounds.AddBound(1, LpColBound::U, idx());
...
TEST_F(TestTheorySolverBoundVector, IsLowerBack) {
  TheorySolverBoundVector bounds{-100, 100};
  bounds.AddBound(1, LpColBound::L, idx());
  bounds.AddBound(2, LpColBound::L, idx());
  bounds.AddBound(3, LpColBound::L, idx());
...
TEST_F(TestTheorySolverBoundVector, IsUpperFront) {
  TheorySolverBoundVector bounds{-100, 100};
  bounds.AddBound(1, LpColBound::U, idx());
  bounds.AddBound(2, LpColBound::U, idx());
  bounds.AddBound(3, LpColBound::U, idx());
  EXPECT_TRUE(bounds.IsUpperBound(1));
  EXPECT_FALSE(bounds.IsLowerBound(1));
}
...
TEST_F(TestTheorySolverBoundVector, IsUpperIsLowerEqualityImplicit) {
  TheorySolverBoundVector bounds{-100, 100};
  bounds.AddBound(1, LpColBound::B, idx());
  EXPECT_TRUE(bounds.IsUpperBound(1));
  EXPECT_TRUE(bounds.IsLowerBound(1));
}

TEST_F(TestTheorySolverBoundVector, AddLowerOnEdge) {
  const auto violation = bounds_.AddBound(3, LpColBound::L, idx());
  EXPECT_FALSE(violation);
}
TEST_F(TestTheorySolverBoundVector, AddUpperOnEdge) {
  const auto violation = bounds_.AddBound(3, LpColBound::U, idx());
  EXPECT_FALSE(violation);
}
TEST_F(TestTheorySolverBoundVector, AddEqualOnEdge) {
  const auto violation = bounds_.AddBound(3, LpColBound::B, idx());
  EXPECT_FALSE(violation);
}
...
TEST_F(TestTheorySolverBoundVector, ViolationLowerOverUpperRight) {
  const auto violation = bounds_.AddBound(6, LpColBound::L, idx());
  EXPECT_TRUE(violation);
  EXPECT_EQ(violation.bounds().first, bounds_.bounds().cbegin() + bounds_.n_lower_bounds());
...
TEST_F(TestTheorySolverBoundVector, ViolationUpperOverLowerLeft) {
  const auto violation = bounds_.AddBound(0, LpColBound::U, idx());
  EXPECT_TRUE(violation);
...
TEST_F(TestTheorySolverBoundVector, ViolationEqualOverLowerLeft) {
  const auto violation = bounds_.AddBound(0, LpColBound::B, idx());
  EXPECT_TRUE(violation);
  EXPECT_EQ(violation.bounds().first, bounds_.bounds().cbegin());
  EXPECT_EQ(violation.bounds().second, bounds_.bounds().cbegin() + bounds_.n_lower_bounds());
}
...
TEST_F(TestTheorySolverBoundVector, ViolationEqualOverUpperRight) {
  const auto violation = bounds_.AddBound(6, LpColBound::B, idx());
  EXPECT_TRUE(violation);
  EXPECT_EQ(violation.bounds().first, bounds_.bounds().cbegin() + bounds_.n_lower_bounds());
  EXPECT_EQ(violation.bounds().second, bounds_.bounds().cend());
}
TEST_F(TestTheorySolverBoundVector, ViolationEqualOverMultipleLower) {
  ...
  empty_bounds_.AddBound(1, LpColBound::SL, idx());
  empty_bounds_.AddBound(2, LpColBound::L, idx());
  const auto violation = empty_bounds_.AddBound(1, LpColBound::B, idx());
  EXPECT_TRUE(violation);
...
TEST_F(TestTheorySolverBoundVector, ViolationEqualOverMultipleUpper) {
  empty_bounds_.AddBound(0, LpColBound::U, idx());
  empty_bounds_.AddBound(1, LpColBound::U, idx());
  empty_bounds_.AddBound(1, LpColBound::SU, idx());
  empty_bounds_.AddBound(2, LpColBound::U, idx());
  const auto violation = empty_bounds_.AddBound(1, LpColBound::B, idx());
...
TEST_F(TestTheorySolverBoundVector, ViolationStrictLowerOverEquality) {
  const auto violation = bounds_.AddBound(3, LpColBound::SL, idx());
  EXPECT_TRUE(violation);
  EXPECT_EQ(violation.bounds().first, bounds_.bounds().cbegin() + bounds_.n_lower_bounds());
...
TEST_F(TestTheorySolverBoundVector, ViolationStrictUpperOverEquality) {
  const auto violation = bounds_.AddBound(3, LpColBound::SU, idx());
  EXPECT_TRUE(violation);
...
TEST_F(TestTheorySolverBoundVector, ViolationStrictInequalityOverEquality) {
  const auto violation = bounds_.AddBound(3, LpColBound::D, idx());
  EXPECT_TRUE(violation);
  EXPECT_EQ(violation.bounds().first, bounds_.bounds().cbegin() + bounds_.n_lower_bounds() - 1);
  EXPECT_EQ(violation.bounds().second, bounds_.bounds().cbegin() + bounds_.n_lower_bounds() + 1);
}
...
TEST_F(TestTheorySolverBoundVector, ViolationLowerOverStrictInequality) {
  ...
  empty_bounds_.AddBound(3, LpColBound::D, idx());
  empty_bounds_.AddBound(4, LpColBound::U, idx());
  const auto violation = empty_bounds_.AddBound(3, LpColBound::L, idx());
  EXPECT_TRUE(violation);
...
TEST_F(TestTheorySolverBoundVector, ViolationUpperOverStrictInequality) {
  ...
  empty_bounds_.AddBound(3, LpColBound::D, idx());
  empty_bounds_.AddBound(4, LpColBound::U, idx());
  const auto violation = empty_bounds_.AddBound(3, LpColBound::U, idx());
  EXPECT_TRUE(violation);
  EXPECT_EQ(violation.bounds_size(), 1u);
  EXPECT_EQ(violation.bounds().first, empty_bounds_.bounds().cbegin() + 1);
  EXPECT_EQ(violation.bounds().second, empty_bounds_.bounds().cend() - 1);
...
TEST_F(TestTheorySolverBoundVector, ViolationLowerOverStrictUpper) {
  ...
  auto violation = empty_bounds_.AddBound(1, LpColBound::L, idx());
  EXPECT_TRUE(violation);
  EXPECT_EQ(violation.bounds().first, empty_bounds_.bounds().cbegin());
  EXPECT_EQ(violation.bounds().second, empty_bounds_.bounds().cbegin() + 1);
}
...
TEST_F(TestTheorySolverBoundVector, ViolationUpperOverStrictLowerStandardNoViolation) {
  EXPECT_FALSE(empty_bounds_.AddBound(1, LpColBound::SL, idx()));
  EXPECT_FALSE(empty_bounds_.AddBound(2, LpColBound::SL, idx()));
  auto violation = empty_bounds_.AddBound(3, LpColBound::U, idx());
  EXPECT_FALSE(violation);
}
...
TEST_F(TestTheorySolverBoundVector, ViolationLowerOverStrictUpperStandardNoViolation) {
  EXPECT_FALSE(empty_bounds_.AddBound(1, LpColBound::SU, idx()));
  EXPECT_FALSE(empty_bounds_.AddBound(2, LpColBound::SU, idx()));
  auto violation = empty_bounds_.AddBound(0, LpColBound::L, idx());
  EXPECT_FALSE(violation);
}
