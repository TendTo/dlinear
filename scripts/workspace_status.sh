...
echo "STABLE_REPOSITORY_STATUS_SHORT $(git describe --tags --dirty --always 2>/dev/null)"
echo "STABLE_REPOSITORY_STATUS_LONG $(git describe --tags --dirty --long 2>/dev/null)"
