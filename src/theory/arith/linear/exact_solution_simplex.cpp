 ...
 */
#include "theory/arith/linear/exact_solution_simplex.h"
...
ExactSolutionSDP::ExactSolutionSDP(Env& env,
...
ExactSolutionSDP::Statistics::Statistics(StatisticsRegistry& sr)
    : d_searchTime(sr.registerTimer("theory::arith::exact::searchTime")),
      d_queueTime(sr.registerTimer("theory::arith::exact::queueTime")),
      d_conflicts(sr.registerInt("theory::arith::exact::conflicts"))
{
}

bool ExactSolutionSDP::matchesNewValue(const DenseMap<DeltaRational>& nv,
                                       ArithVar v) const
{
