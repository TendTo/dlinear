...
function run() {
    ...
    ./dlinear "$file" -t -p 0.001 --csv --bound-implication-frequency never --bound-propagation-frequency never --disable-expansion > "$output_dir/$filename.dlinear.0.001.stats"
}
