...
class ExpressionCell : public std::enable_shared_from_this<ExpressionCell> {
 public:
   ...
   */
  [[nodiscard]] virtual mpq_class Evaluate(const Environment& env) const = 0;
   ...
   */
  [[nodiscard]] virtual Expression EvaluatePartial(const Environment& env) const = 0;
...
class UnaryExpressionCell : public ExpressionCell {
 ...
 protected:
  ...
  [[nodiscard]] virtual mpq_class DoEvaluate(mpq_class v) const = 0;
...
class BinaryExpressionCell : public ExpressionCell {
 ...
 protected:
  ...
  [[nodiscard]] virtual mpq_class DoEvaluate(mpq_class v1, mpq_class v2) const = 0;
...
class ExpressionConstant : public ExpressionCell {
 public:
  NEW_OPERATOR_PARAMS(ExpressionConstant, const mpq_class& constant, constant);

  [[nodiscard]] const mpq_class& value() const { return v_; }
  [[nodiscard]] Variables variables() const override;
...
class ExpressionDiv : public BinaryExpressionCell {
 ...
 private:
  [[nodiscard]] mpq_class DoEvaluate(mpq_class v1, mpq_class v2) const override;
};
...
class ExpressionLog : public UnaryExpressionCell {
 ...
 private:
  ...
  [[nodiscard]] mpq_class DoEvaluate(mpq_class v) const override;
};
