...
The package has been uploaded to the \texttt{PyPI} repository, making it available to anyone with a \texttt{Linux x86\_64} machine.
The package can be installed with the command \texttt{pip install pydlinear}.
