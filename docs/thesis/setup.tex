...
% Common definitions
%%%%%%%%%%%%%%%%%%%%%%%%
\def\dlinear{\textit{dLinear }}
\def\pydlinear{\textit{pydLinear }}
\def\dlinearfive{\textit{dLinear5 }}
\def\dlinearfour{\textit{dLinear4 }}
\def\bazel{\textit{Bazel }}
\def\dreal{\textit{dReal4 }}
