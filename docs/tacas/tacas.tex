...
\includegraphics[width=0.45\linewidth]{img/total_lp.pdf}
    ...
    %\textcolor{red}{change the axis range to reduce the white space inside the left figure. The figures have low quality saved as png. Could you create them with higher quality or as pdf?}
    }
...
\begin{figure}
    ...
    %\textcolor{red}{Could you create them with higher quality or as pdf?}
    }
    \label{fig:results-smt}
\end{figure}
...
%\textcolor{red}{Shouldn't the next paragraph better be in Section 6 (or 5)?}
